    ...
    <section id="home" class="w3l-banner py-5">
        ...
        <div class="container py-lg-5 py-md-3">
            <div class="row">
                <div class="card shadow col-lg-6 about-right-faq align-self pr-lg-5" style="border-radius: 3rem !important;">
                    <h3 class="title-big mt-3">Tentang Aplikasi</h3>
            ...
            <div class="row mt-5 pt-5">
                ...
                <div class="card shadow col-lg-6 about-right-faq align-self pl-lg-5 order-lg-last order-first" style="border-radius: 3rem !important;">
                    <p class="mt-2">
                        <?php 
                            if(!empty($desc)) {
                                foreach ($desc as $row) {

        ...
        <div class="banner-content">
            <div class="container pt-5 pb-md-4">
                <div class="row align-items-center">
                    <div class="col-md-6 pt-md-0 pt-4 animated zoomIn">
                    ...
                    <div class="col-md-6 mt-md-0 mt-4 animated fadeInRight">
                        <img src="<?php echo base_url('assets/frontend/images/10586.png'); ?>" alt="" class="img-fluid radius-image">
                    </div>
                </div>
                <div class="row align-items-center">
                    <div class="col-md-6 pt-md-0 pt-4 about-right-faq animated zoomIn">
                        <div class="card shadow rounded" style="border-radius: 1rem !important;">
                            <p align="justify" class="mx-3 my-3">
                            <?php
                            if (!empty($desc)) {
                    ...
                    <div class="col-lg-6 left-wthree-img mt-lg-0 mt-5 order-lg-first order-last animated fadeInUp">
